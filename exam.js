...
total=carBooking.map(item=>item[5]).reduce((avl1,avl2)=>avl1+avl2)
console.log(total);
console.log("---------------------------------------")
...
console.log('cars with price perday greater than 60');
carBooking.filter(item=>item[4]>60).forEach(car=>console.log(car[1]))
console.log("---------------------------------------");

//5)print details of 'jeep wrangler'
console.log('details of jeep wrangler');
console.log(carBooking.find(item=>item[1]=='Jeep'));
console.log("---------------------------------------");
...
x=carBooking.map(item=>item[5]).reduce((car1,car2)=>car1+car2)
console.log(x);
console.log("---------------------------------------");
